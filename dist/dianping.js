...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__base_dianping_coffee__ = __webpack_require__(6);


$(function() {
  var o;
  o = new __WEBPACK_IMPORTED_MODULE_0__base_dianping_coffee__["a" /* default */]();
  return o.add();
});
...
// 利用继承的关系来简化设计
dianping = class dianping extends __WEBPACK_IMPORTED_MODULE_0__base_coffee__["a" /* default */] {
  getURL(url) {
    url = super.getURL(url);
    return 'http://mytraveler.zhaobing/getHotelInfo/' + this.getKey(url);
  }

  getKey(url) {
    return url.replace(/.*\/([0-9]+)/img, "$1");
  }

};

/* harmony default export */ __webpack_exports__["a"] = (dianping);
