...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__base_baiduxueshu_coffee__ = __webpack_require__(12);


$(function() {
  var o;
  o = new __WEBPACK_IMPORTED_MODULE_0__base_baiduxueshu_coffee__["a" /* default */]();
  return o.add();
});
...
baiduxueshu = class baiduxueshu extends __WEBPACK_IMPORTED_MODULE_0__base_coffee__["a" /* default */] {
  getURL(url) {
    url = url || location.href;
    return `http://mydocuments/standards/addWebData/baiduxueshu/${Object(__WEBPACK_IMPORTED_MODULE_1__base64encode_coffee__["a" /* default */])(url)}`;
  }

  addLink() {
    return this.createAlink(' 下载', this.getURL()).appendTo($('h3').first());
  }

};

/* harmony default export */ __webpack_exports__["a"] = (baiduxueshu);
